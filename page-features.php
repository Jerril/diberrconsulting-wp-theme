      ...
      <div class="main-page-content">
        ...
        <?php 
            ...
            $contents = get_posts(array(
              ...
              "post_status"=>"publish", 
              "posts_per_page"=>-1,
              "meta_query"=>array(array("key"=>"content_type", "value"=>"features"))));
            ...
            if(!empty($type_query)){
              $feature = get_term_by('slug', $type_query, 'feature');

              foreach($contents as $i=> $content){
                $grp = $content->feature_article_group;
                $grp = $grp['fa_category'] ?? '';
                if($grp != $feature->term_id){
                  unset($contents[$i]);
                }
              }
            }
              ...
              <div class="col-md-3 primaryborderright py-md-4 mt-4 mt-md-0">
                ...
                <div class="alignicons mt-1">
                  <select name="type" class="form-control select topselect secondaryinput">
                    ...
                    <?php $types = get_terms(array('taxonomy'=>'feature', 'hide_empty'=>false));
                      if($types){
                      ...
                      <div class="d-flex">
                        <div class="mainheader4 primaryborderright secondarycolor">
                          <button class="btn secondarycolor mainheader4">
                            ...
                            <span class="secondarycolor py-5 mainheader4"><?php next_posts_link( 'Older posts' ); ?></span>
                          </button>
                        </div>
                        <div class="mainheader4 secondarycolor">
                          <button class="btn secondarycolor mainheader4">
                            <!-- <span class="secondarycolor py-5 mainheader4">Next</span> -->
                            <span class="secondarycolor py-5 mainheader4"><?php previous_posts_link( 'Newer posts' ); ?></span>
                          </button>
                        </div>
                      </div>
                    </div>
