...
?>
      ...
      <div class="main-page-content">
        ...
        <?php 
            $contents = get_posts(array("post_type"=>"content", "post_status"=>"publish", "posts_per_page"=>-1, "meta_query"=>array(array("key"=>"content_type", "value"=>"career"))));
            ...
            if(!empty($type_query)){
              $job = get_term_by('slug', $type_query, 'career');
              ...
              <div class="col-md-3 primaryborderright py-md-4 mt-4 mt-md-0">
                ...
                <div class="alignicons mt-1">
                  <select name="type" class="form-control select topselect secondaryinput">
                    ...
                    <?php $types = get_terms(array('taxonomy'=>'career', 'hide_empty'=>false));
                      if($types){
